        ...
        <div className="row">
          ...
          <div className="col-12 col-lg-8">
            <div className="row g-0 acordeon-height py-5">
              ...
              {/* Acordeón */}
              <div className="col-12 col-lg-8 p-0 user-info rounded-end-4 p-5 mb-5">
                <h3 className="mb-3 mt-3 ">Tomás Lanzillotta</h3>
              ...
              {/* Acordeón */}
              <div className="col-12 col-lg-8 p-0 user-info rounded-end-4 p-5 mb-5">
                <h3 className="mb-3 mt-3 ">Mariela Garcia</h3>
          ...
          <div className="col-12 col-lg-3 d-flex align-items-center justify-content-center pb-4 pb-lg-0">
            <span className="fs-3 fw-bold text-center text-lg-start">Director Ejecutivo de Formación Cívica</span>
          </div>

          {/* Separador vertical */}
          <div className="col-1 d-none d-flex justify-content-center">
            <div
              className="border-end border-black"
              style={{
                height: "300px",
          ...
          <hr className="col-12 d-block mt-4 d-lg-none" />

          {/* Columna derecha: Imagen y Acordeón */}
          <div className="col-12 col-lg-8">
            <div className="row g-0 acordeon-height py-5 mb-5">
              ...
              <div className="col-12 col-lg-8 p-0 rounded-end-4 p-5 mb-5" style={{ backgroundColor: '#f7e4e8' }}>
                <h3 className="mb-3 mt-4">Nicolás Deane</h3>
              </div>
            </div>
          </div>
        </div>
