        ...
        <div className="row">
          ...
          <div className="col-12 col-lg-8">
            <div className="row g-0 acordeon-height py-5">
              ...
              {/* Acordeón */}
              <div className="col-12 col-lg-8 p-0 user-info rounded-bottom-4 rounded-bottom-sm-0 rounded-end-4 p-5 mb-5">
          ...
          <div className="col-12 col-lg-8">
            <div className="row g-0 acordeon-height py-5">
              ...
              {/* Acordeón */}
              <div className="col-12 col-lg-8 p-0 rounded-bottom-4 rounded-bottom-sm-0 rounded-end-4  p-5 mb-5" style={{ backgroundColor: '#f7e4e8' }}>
