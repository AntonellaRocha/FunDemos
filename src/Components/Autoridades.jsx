    ...
    <>
      ...
      <div className="container py-5">
        <div className="row">
          ...
          <div className="col-8">
            <div className="row no-gutters acordeon-height py-5">

              {/* Imagen */}
              <div className="col-4 px-5 mb-5">
                <img src="/img/JUAN PABLO PREZZOLI.jpg" className="" alt="img1" />
              </div>

              {/* Acordeón */}
              <div className="col-8 p-0 user-info rounded-end-4 p-5 mb-4">
              ...
              {/* Imagen */}
              <div className="col-4  px-5 mb-5">
                <img src="/img/TOMAS LANZILLOTTA.jpg" className="" alt="img2" />
              </div>
              ...
              {/* Imagen */}
              <div className="col-4 px-5 mb-5">
                <img src="/img/MARIELA GARCÍA.jpg" className="" alt="img3" />
              </div>
